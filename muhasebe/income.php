...
<html>
      ...
      <body>
            ...
            <section class="content">
                  ...
                  <?php if(isset($_GET['add'])){ ?>
                        <div class="modal">
                                <form method="post" action="_ajax/_ajaxAddIncome.php" class="panel-default modal-medium">
    ...
    <select name="category_id" class="form-control">
        <?php 
        // Sadece gelir kategorilerini listele
        $list = $pia->query("SELECT * FROM categories WHERE type='income' ORDER BY title ASC"); 
        ...
        <?php } ?>
                  ...
                  ?>    
                         <div class="modal">
                        <form method="post" action="_ajax/_ajaxEditIncome.php" class="panel-default modal-medium">
    ...
    <select name="category_id" class="form-control">
        ...
        <?php } ?>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                      <label>Tarih&Saat</label>
                                                      <input type="datetime-local" name="adddate" class="form-control" value="<?=$edit_row->adddate;?>" />
                                                </div>
                                    ...
                                    <div class="panel-default modal-medium">
                                          ...
                                          <div class="panel-body">
                                                <div class="form-group">
                                                      ...
                                                      <div class="form-group">
                                                            <strong>Tutar : </strong>
                                                            <span class="text-success">+<?=$edit_row->price;?> TRY</span>
                                                      </div>
                              ...
                              <table class="table">
                                    ...
                                    <tbody>
                                          ...
                                          <?php 
                                                ...
                                                $list = $pia->query("SELECT * FROM finances WHERE event_type=1");  
                                                foreach($list as $item){ 
